...
static void CC_lookup_and_set_encrypt_type(ConnectionClass *self);
...
CC_connect(ConnectionClass *self, char *salt_para)
{
	...
	/* set TDEforPG type for mapping. */
	CC_lookup_and_set_encrypt_type(self);
...
/* Mapping TDEforPG data type's OID with psqlODBC's internal variable. *
 *
 ...
 * */
static void
CC_lookup_and_set_encrypt_type(ConnectionClass *self)
{
	QResultClass	*res;
	const char *typename;
	OID	basetype;
